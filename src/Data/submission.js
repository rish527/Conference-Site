export const paras={
    para1:"An International Conference on Emerging Engineering Technologies and Applications (ICEETA-2026) will be organized by Indira Gandhi National Tribal University - Regional Campus Manipur India in association with Omyaa Education and Research Foundation (OERF),  U.P., India on 20th-21st February 2026. The aim of the ICEETA2026 is to serve researchers, developers, educators working in the area of Computer Science, Electronics, and Computing Technologies to present as well as to exchange the research ideas. ICEETA-2026 invites authors to submit their original and unpublished work that demonstrates current research in all areas of science technology and sustainable development through Microsoft Conference Management Toolkit https://cmt3.research.microsoft.com/ICEETA2026 If you encounter problems in submitting, contact at  iceetaigntu@gmail.com Acceptance of papers will be communicated to authors by email.",
    guidlines:"At least one author of an accepted paper must register and present his / her paper in conference. Authors are invited to submit original papers of 6 pages in A4 size using the attached template, with one accepted paper covered under standard registration. Papers exceeding 6 pages will incur extra page charges",
    manuscript:[
        "The manuscript should be prepared in CRC template using MS WORD and/or LaTeX template.",
        ...
        "Do NOT use any Social/Academic titles (e.g. Mr., Ms., Dr., Prof. etc) preceding the author names. Do NOT mention the position of a person (e.g., research scholar, student, assistant professor, professor etc.) in the affiliation.",
